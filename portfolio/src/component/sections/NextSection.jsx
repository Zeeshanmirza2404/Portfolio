...
const NextSection = () => {
  ...
  return (
    <section className="py-5 position-relative overflow-hidden" style={{ paddingTop: "8rem", paddingBottom: "8rem" }}>
      {/* Gradient background */}
      <div
      ...
      <div className="container position-relative" style={{ zIndex: 10 }}>
        ...
        >
          <div
            className="card bg-dark bg-opacity-50 border-secondary p-4 p-md-5"
            style={{
          ...
          >
            <div className="d-flex flex-column flex-md-row align-items-start gap-4">
              ...
              <div className="flex-grow-1">
                ...
                <h2 className="h3 fw-bold mb-3" style={{ fontSize: "1.75rem" }}>AI-Driven Development</h2>
                <p className="fs-5 text-secondary lh-lg mb-4" style={{ fontSize: "1.125rem" }}>
                  Currently integrating AI agents into web platforms for automation
                  and smart systems. From intelligent form processing to predictive
                  user experiences—I'm building the next generation of web applications.
                </p>
