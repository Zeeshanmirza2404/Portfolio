...
const HeroSection = () => {
  return (
    <section className="min-vh-100 d-flex align-items-center justify-content-center position-relative overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            width: "600px",
            height: "600px",
            background: "radial-gradient(circle, rgba(85, 22, 134, 1) 0%, rgba(33, 16, 79, 1) 40%, transparent 70%)",
            filter: "blur(60px)",
          }}
        />
        ...
        <motion.div
          ...
          style={{
            ...
            width: "700px",
            height: "700px",
            background: "radial-gradient(circle, rgba(33, 16, 48, 0.28) 0%, rgba(93, 0, 255, 1) 40%, transparent 70%)",
            filter: "blur(70px)",
          }}
        />
        ...
        <div className="row align-items-center g-5">
          ...
          <div className="col-lg-6">
            <motion.div
              ...
              className="d-inline-flex align-items-center gap-2 px-3 py-2 rounded-pill border small fs-6 text-secondary mb-4"
              style={{
            ...
            <motion.h1
              ...
              className="display-2 fw-medium mb-4"
              style={{ 
                fontSize: "4.25rem",
                fontWeight: 900,
            ...
            <motion.p
              ...
              className="mb-4"
              style={{ lineHeight: "1.6", fontSize: "1.25rem", color: "rgba(255, 255, 255, 0.5)" }}
            >
            ...
            >
              ...
              <a href="/Zeeshan_Resume2026.pdf" download="Resume.pdf" className="btn d-inline-flex align-items-center gap-2 px-4 py-2" style={{ fontSize: "1.125rem", color: '#7c3aed', borderColor: '#7c3aed' }}>
                <Download size={18} />
                Download Resume
              </a>
            </motion.div>
